...
public class OrdersBuCustomerController implements Initializable{
	...
	public void show1(ActionEvent e)
	{
		...
		if(Main.res.getOrderByCustomer().get(cust.getValue())!=null) {
		TreeSet<Order> arr=new TreeSet<Order>(Main.res.getOrderByCustomer().get(cust.getValue()));
