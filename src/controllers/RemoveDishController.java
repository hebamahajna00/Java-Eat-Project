...
public class RemoveDishController implements Initializable{
	...
	public void remoove(ActionEvent e)
	{
		...
		Dish c=compo.getSelectionModel().getSelectedItem();
		if(!Main.res.removeDish(c))
		{
			
			compo.getSelectionModel().clearSelection();
			Alert a=new Alert(AlertType.CONFIRMATION);
			a.setHeaderText("Failed to remove Dish");
			a.showAndWait();
		}
		else
		{
			...
			Main.update();;
			Alert a=new Alert(AlertType.CONFIRMATION);
			a.setHeaderText("Successfully removed Dish");
			a.showAndWait();
		}
		}
